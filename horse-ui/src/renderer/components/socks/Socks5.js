...
function socks5(socksHost, socksPort, socket) {
	var self = this;
...
//socks5 继承EventEmitter。 但是没有父类的方法， 需要调用call才有
inherits(socks5, EventEmitter);

socks5.create = function (socksHost, socksPort, socket) {
	return new socks5(socksHost, socksPort, socket);
};
